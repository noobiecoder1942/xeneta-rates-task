...
def get_average_rates(date_from, date_to, origin, destination, date_format):
    ...
    average_rates = []
    for row in db_rows:
        average_rates.append(convert_row_to_dict(row, date_format))
    return average_rates

def convert_row_to_dict(row, date_format):
    result = {
